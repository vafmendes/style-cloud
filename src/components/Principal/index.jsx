...
export default function Hero(){
    return(
            <div  id="home" className="relative bg-gradient-to-r from-color3 to color2 lg:py-12 py-40 overflow-hidden z-[-50]">
            <div className="xl:w-4/5 px-[20px] max-w-[1380px] mx-auto relative lg:h-[100vh] flex flex-col justify-center">
                ...
                <div className="h-full flex justify-center items-center w-full overflow-hidden">
                    <div className="bg-dark rounded-full shadow relative lg:w-96 w-64 lg:h-96 h-64">
                        <div className="flex flex-col items-center justify-center bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full p-7 absolute top-[-2px] left-[-90px] z-10" data-aos="fade-up">
                    ...
                    <img src={Img2} alt="crocs" className="bg-cover rotate-[10deg] lg:w-30 w-2/3 absolute lg:pl-48 lg:pb-79 pb-16 z-90" data-aos="fade-up"/>
                </div>
